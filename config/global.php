...
$config['http_reverse_link'] = 'http://127.0.0.0:' . $config['port'];
...
$config['swoole'] = [
    ...
    'worker_num' => swoole_cpu_num() * 4, //如果你只有一个 OneBot 实例连接到框架并且代码没有复杂的CPU密集计算，则可把这里改为1使用全局变量
